...
# print(pesel_to_list)
pesel_check_pattern = (int(pesel_to_list[0]) * 1) + (int(pesel_to_list[1]) * 3) + (int(pesel_to_list[2]) * 7)\
...
print(f"suma mnożenia ze wzoru na poprawny pesel: {pesel_check_pattern}")
print(type(pesel_check_pattern))

last_pesel_number_str = str(pesel_check_pattern)
